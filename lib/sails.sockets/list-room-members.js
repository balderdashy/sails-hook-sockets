...
module.exports = function (app){
  ...
  return function listRoomMembers (roomName, returnSockets, cb) {
    ...
    // The synchronous usage uses undocumented adapter properties!
    app.log.warn("Synchronous usage of sails.sockets.subscribers() is deprecated.  Please use `sails.sockets.subscribers(roomName, cb);`");
