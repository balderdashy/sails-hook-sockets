...
module.exports = function ToConfigure(app) {
  ...
  return function configure (){
    ...
    if (app.config.sockets.adminPubClient) {
      app.config.sockets.adapterOptions.adminPubClient = app.config.sockets.adminPubClient;
    }
    if (app.config.sockets.adminSubClient) {
      app.config.sockets.adapterOptions.adminSubClient = app.config.sockets.adminSubClient;
    }
